...
func DeleteLogs(paymentIDs *[]int32, database string) error {
...
func GetPaymentIDs(n int, database string) (*[]int32, error) {
	paymentIDs := []int32{}
...
func GetLogs(paymentIDs *[]int32, database string) (*[]models.PaymentLog, error) {
